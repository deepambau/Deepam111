...
module.exports = {
  config: {
    ...
    longDescription: "Bring your imaginative prompts to life with visually stunning images using the Mobius AI system.",
    category: "AI Tools",
    guide: "{p}alchemy pro <your prompt>",
  },
  ...
  onStart: async function ({ message, args, api, event }) {
    ...
    try {
      const apiUrl = `https://mahi-apis.onrender.com/api/alchemy?prompt=${encodeURIComponent(prompt)}`;
